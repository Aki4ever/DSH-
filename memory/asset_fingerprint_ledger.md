...
| `ai-control/plugin/index.mjs` | `fe2e1768` | 2026-09-23 14:11 | `-` | ⚪ TIER-2 | 指纹监控中 |
| `ai-control/plugin/loader.mjs` | `13ef6615` | 2026-09-23 07:47 | `-` | ⚪ TIER-2 | 指纹监控中 |
| `ai-control/plugin/selftest.mjs` | `5588fe2c` | 2026-09-23 14:12 | `-` | ⚪ TIER-2 | 指纹监控中 |
| `memory/.gitkeep` | `e3b0c442` | 2026-09-16 15:37 | `-` | ⚪ TIER-2 | 指纹监控中 |
| `memory/README.md` | `2778de38` | 2026-09-16 15:37 | `-` | ⚪ TIER-2 | 指纹监控中 |
| `memory/asset_fingerprint_ledger.md` | `31bd90fa` | 2026-09-23 14:12 | `v3.1.0` | 🟢 TIER-0 | 最新基线 |
