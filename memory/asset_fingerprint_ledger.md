...
| :--- | :---: | :--- | :--- |
| **完全新鲜 (Fresh)** | 🟢 `TIER-0` | 声明版本与系统最新总基线完全一致 (`v2.8.0`) | 资产处于最优生效态，免修改直接运行 |
...
| `rules/system/language_standard.md` | `e0c9f6d8` | 2026-09-22 19:58 | `v2.7.0` | 🟡 TIER-1 | 待升级对齐 |
| `rules/system/meta_rules.md` | `7bfe23d6` | 2026-09-22 19:58 | `v2.7.0` | 🟡 TIER-1 | 待升级对齐 |
...
| `rules/workflow/task_execution_flow.md` | `4a895933` | 2026-09-22 19:58 | `v2.7.0` | 🟡 TIER-1 | 待升级对齐 |
...
| `knowledge/README.md` | `9e8f14e0` | 2026-09-22 19:59 | `v2.7.0` | 🟡 TIER-1 | 待升级对齐 |
...
| `indexes/dsh_capabilities.md` | `4b0c17b0` | 2026-09-22 19:59 | `v2.7.0` | 🟡 TIER-1 | 待升级对齐 |
| `indexes/extension_ecosystem.md` | `a24b9d6e` | 2026-09-16 19:25 | `v2.3.0` | 🟡 TIER-1 | 待升级对齐 |
| `indexes/rules_index.md` | `17a1a001` | 2026-09-22 19:59 | `v2.7.0` | 🟡 TIER-1 | 待升级对齐 |
| `indexes/shortcuts_index.md` | `754c4ef7` | 2026-09-22 19:59 | `v2.7.0` | 🟡 TIER-1 | 待升级对齐 |
| `indexes/tool_interfaces.md` | `ea1e255b` | 2026-09-22 19:59 | `v2.7.0` | 🟡 TIER-1 | 待升级对齐 |
...
| `docs/requirements.md` | `99a3e2b5` | 2026-09-22 20:32 | `v2.8.0` | 🟢 TIER-0 | 最新基线 |
| `docs/rules_tutorial.md` | `f71ad4d9` | 2026-09-16 14:41 | `-` | ⚪ TIER-2 | 指纹监控中 |
| `ai-control/README.md` | `c5691b65` | 2026-09-22 20:21 | `-` | ⚪ TIER-2 | 指纹监控中 |
...
| `AGENTS.md` | `a74716f3` | 2026-09-22 20:20 | `-` | ⚪ TIER-2 | 指纹监控中 |
| `README.md` | `d060e679` | 2026-09-22 20:40 | `v2.8.0` | 🟢 TIER-0 | 最新基线 |
