...
| :--- | :---: | :--- | :--- |
| **完全新鲜 (Fresh)** | 🟢 `TIER-0` | 声明版本与系统最新总基线完全一致 (`v2.7.0`) | 资产处于最优生效态，免修改直接运行 |
...
| `rules/system/language_standard.md` | `e0c9f6d8` | 2026-09-22 19:58 | `v2.7.0` | 🟢 TIER-0 | 最新基线 |
| `rules/system/meta_rules.md` | `7bfe23d6` | 2026-09-22 19:58 | `v2.7.0` | 🟢 TIER-0 | 最新基线 |
...
| `rules/workflow/task_execution_flow.md` | `4a895933` | 2026-09-22 19:58 | `v2.7.0` | 🟢 TIER-0 | 最新基线 |
...
| `knowledge/README.md` | `9e8f14e0` | 2026-09-22 19:59 | `v2.7.0` | 🟢 TIER-0 | 最新基线 |
...
| `indexes/dsh_capabilities.md` | `4b0c17b0` | 2026-09-22 19:59 | `v2.7.0` | 🟢 TIER-0 | 最新基线 |
| `indexes/extension_ecosystem.md` | `a24b9d6e` | 2026-09-16 19:25 | `v2.3.0` | 🟡 TIER-1 | 待升级对齐 |
| `indexes/rules_index.md` | `17a1a001` | 2026-09-22 19:59 | `v2.7.0` | 🟢 TIER-0 | 最新基线 |
| `indexes/shortcuts_index.md` | `754c4ef7` | 2026-09-22 19:59 | `v2.7.0` | 🟢 TIER-0 | 最新基线 |
| `indexes/tool_interfaces.md` | `ea1e255b` | 2026-09-22 19:59 | `v2.7.0` | 🟢 TIER-0 | 最新基线 |
...
| `docs/requirements.md` | `cd965b89` | 2026-09-22 19:59 | `v2.7.0` | 🟢 TIER-0 | 最新基线 |
