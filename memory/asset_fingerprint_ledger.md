...
| :--- | :---: | :--- | :--- |
| **完全新鲜 (Fresh)** | 🟢 `TIER-0` | 声明版本与系统最新总基线完全一致 (`v2.5.0`) | 资产处于最优生效态，免修改直接运行 |
...
| `rules/system/language_standard.md` | `058c26ae` | 2026-09-18 16:07 | `v2.5.0` | 🟢 TIER-0 | 最新基线 |
| `rules/system/meta_rules.md` | `be403b9e` | 2026-09-18 16:06 | `v2.5.0` | 🟢 TIER-0 | 最新基线 |
...
| `rules/workflow/task_execution_flow.md` | `8bd021fd` | 2026-09-18 16:07 | `v2.5.0` | 🟢 TIER-0 | 最新基线 |
...
| `knowledge/README.md` | `3c58bb39` | 2026-09-18 16:10 | `v2.5.0` | 🟢 TIER-0 | 最新基线 |
...
| `indexes/dsh_capabilities.md` | `2d5b2e47` | 2026-09-18 16:11 | `v2.5.0` | 🟢 TIER-0 | 最新基线 |
| `indexes/extension_ecosystem.md` | `a24b9d6e` | 2026-09-16 19:25 | `v2.3.0` | 🟡 TIER-1 | 待升级对齐 |
| `indexes/rules_index.md` | `a132f56e` | 2026-09-18 16:08 | `v2.5.0` | 🟢 TIER-0 | 最新基线 |
| `indexes/shortcuts_index.md` | `7f3050f6` | 2026-09-18 16:12 | `v2.5.0` | 🟢 TIER-0 | 最新基线 |
| `indexes/tool_interfaces.md` | `47dab77a` | 2026-09-18 16:11 | `v2.5.0` | 🟢 TIER-0 | 最新基线 |
...
| `docs/requirements.md` | `85d8f761` | 2026-09-18 16:10 | `v2.5.0` | 🟢 TIER-0 | 最新基线 |
