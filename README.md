...
本项目用于集中管理、统一维护智能体与系统运行的各类全局规则、工作流程、代码工程规范、统一知识库、快速通道索引以及核心需求台账。
...
│   └── README.md                    # 记忆层专属说明文档
├── docs/                            # 【说明与核心台账】
│   ├── requirements.md              # 独立核心需求管理台账（REQ-001 ~ REQ-022，总版本 v1.1.0）
...
4. **查台账**：检索 `docs/requirements.md` 了解需求当前进展、边界与当前实施总版本号（`v1.1.0`）；
